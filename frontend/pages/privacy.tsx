          ...
          <Paper className={styles.contentPaper}>
            ...
            <motion.div variants={fadeInUp} custom={3}>
              ...
              <Typography className={styles.bodyText}>
                ...
                correct, or remove any data we hold, contact us at{' '}
            ...
            <motion.div variants={fadeInUp} custom={4}>
              ...
              <List className={styles.list}>
                <ListItem className={styles.listItem}>• Request access to your personal data</ListItem>
                <ListItem className={styles.listItem}>• Request correction of inaccurate data</ListItem>
                <ListItem className={styles.listItem}>• Request deletion of your data</ListItem>
                <ListItem className={styles.listItem}>• Withdraw your consent at any time</ListItem>
              </List>
            </motion.div>
          </Paper>
        </motion.div>
